...
class Member(object):
    ...
    def __init__(self, host, ismain_response, ping_time, connection_pool):
        self.host = host
        self.pool = connection_pool
        self.ping_time = MovingAverage(5)
        self.update(ismain_response, ping_time)

    def update(self, ismain_response, ping_time):
        ...
        for node in nodes:
            ...
            try:
                if node in self.__members:
                    ...
                    response, _, _ = self.__is_main(node)
