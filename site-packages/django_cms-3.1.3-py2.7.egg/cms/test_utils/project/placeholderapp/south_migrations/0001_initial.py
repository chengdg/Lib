...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'placeholderapp_multilingualexample1_translation', (
            ...
            ('main', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['placeholderapp.MultilingualExample1'])),
        ))
        db.send_create_signal(u'placeholderapp', ['MultilingualExample1Translation'])

        # Adding unique constraint on 'MultilingualExample1Translation', fields ['language_code', 'main']
        db.create_unique(u'placeholderapp_multilingualexample1_translation', ['language_code', 'main_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'MultilingualExample1Translation', fields ['language_code', 'main']
        db.delete_unique(u'placeholderapp_multilingualexample1_translation', ['language_code', 'main_id'])
    ...
    models = {
        ...
        u'placeholderapp.multilingualexample1translation': {
            'Meta': {'unique_together': "[('language_code', 'main')]", 'object_name': 'MultilingualExample1Translation', 'db_table': "u'placeholderapp_multilingualexample1_translation'"},
            'char_1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'char_2': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'main': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['placeholderapp.MultilingualExample1']"})
        },
