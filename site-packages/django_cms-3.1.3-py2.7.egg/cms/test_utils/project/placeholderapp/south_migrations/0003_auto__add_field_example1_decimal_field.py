...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Example1.decimal_field'
        db.add_column(u'placeholderapp_example1', 'decimal_field',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Example1.decimal_field'
        db.delete_column(u'placeholderapp_example1', 'decimal_field')
    ...
    models = {
        ...
        u'placeholderapp.multilingualexample1translation': {
            'Meta': {'unique_together': "[('language_code', 'main')]", 'object_name': 'MultilingualExample1Translation', 'db_table': "u'placeholderapp_multilingualexample1_translation'", 'index_together': '()'},
            'char_1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'char_2': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
