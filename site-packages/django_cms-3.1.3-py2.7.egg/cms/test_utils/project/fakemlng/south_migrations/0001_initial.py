...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fakemlng_translations', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('main', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fakemlng.MainModel'])),
        ...
        # Adding unique constraint on 'Translations', fields ['main', 'language_code']
        db.create_unique(u'fakemlng_translations', ['main_id', 'language_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Translations', fields ['main', 'language_code']
        db.delete_unique(u'fakemlng_translations', ['main_id', 'language_code'])
    ...
    models = {
        ...
        u'fakemlng.translations': {
            'Meta': {'unique_together': "[('main', 'language_code')]", 'object_name': 'Translations'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'main': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fakemlng.MainModel']"}),
