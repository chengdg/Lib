...
#	((DRAWNS,u'id'), None): cnv_nonNegativeInteger,   # ?? line 6581 in RNG
	...
	((DRAWNS,'main-page-name'), None): cnv_StyleNameRef,
...
#	((FORMNS,u'current-value'), None): cnv_time,
	...
	((FORMNS,'main-fields'), None): cnv_string,
...
#	((FORMNS,u'value'), None): cnv_time,
	...
	((PRESENTATIONNS,'main-element'), None): cnv_IDREF,
	...
	((STYLENS,'main-page-name'), None): cnv_StyleNameRef,
...
#	((TEXTNS,u'id'), None): cnv_string,
	...
	((TEXTNS,'main-page-name'), None): cnv_StyleNameRef,
